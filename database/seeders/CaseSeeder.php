                ...
                'content_components' =>
                    [
                        ...
                        [
                            "type" => "richtext",
                            "data" => [
                                "content" => "<h3>方案</h3><p>SEO搜索關鍵詞優化 極速提升網站排名<br>ECEC 為i-Math行關鍵詞調查，並針對與數學補習相關的關鍵詞實行SEO搜索關鍵詞優化，以增加網站點擊的客戶轉化率。通過每週持續優化他們的網站關鍵詞及加入大量優質反向連結(Backlinks)，令以i-Math獲得更好的搜索引擎排名，幫助他們接觸到更多的學生，增加報讀他們課程的客戶數量。<br><br>另外，我們亦針對i-Math的地理位置進行了客製化關鍵詞優化，當中包括「將軍澳數學」、「坑口補習」、「油塘補習」等等，以 擴大i-Math主要收學範圍的網絡知名度，符合客戶需求。</p>"
                            ]
                        ],
                        [
                            "type" => "image",
                ...
                'content_components' =>
                    [
                        ...
                        [
                            "type" => "richtext",
                            "data" => [
                                "content" => "<h3>方案</h3><p>SEO搜索關鍵詞優化 極速提升網站排名<br>ECEC 為Ms Priscilla行關鍵詞調查，並針對與英文補習相關的關鍵詞實行SEO搜索關鍵詞優化，以增加網站點擊的客戶轉化率。通過每週持續優化他們的網站關鍵詞及加入大量優質反向連結(Backlinks)，令Ms Priscilla獲得更好的搜索引擎排名，幫助他們接觸到更多的學生，增加報讀他們課程的客戶數量。</p>"
                            ]
                        ],
                        [
                            "type" => "image",
                ...
                'content_components' =>
                    [
                        ...
                        [
                            "type" => "richtext",
                            "data" => [
                                "content" => "<h3>成效</h3><p>ECEC團隊針對多組網上課程相關關鍵字加強點擊率。其中關鍵字「DSE網上課程」已穩定佔據搜索排名第二位。該合作獲得成功，網站排名流量和流量都獲得明顯的提升。<br><br></p><h3>數據</h3><p>(3個月內) 登上Google搜尋排名前三</p>"
                            ]
                        ]
                    ]
            ],
