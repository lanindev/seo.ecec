    ...
    <div>
        ...
        <div class="grid gap-10 md:grid-cols-2 lg:grid-cols-3">
            @foreach ($data["cards"] as $card)
                @if ($card["icon"] !== null || $card["title"] !== null || $card["description"] !== null)
                    <div
                    ...
                    >
                        @if ($card["icon"])
                            <div
                                class="mx-auto mb-6 flex h-20 w-20 items-center justify-center rounded-full bg-sky-600 text-white shadow-md transition-transform duration-300 group-hover:scale-110"
                            >
